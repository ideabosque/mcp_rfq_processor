...
def mcp_rfq_processor():
    """Provide an MCPRfqProcessor instance for testing.

    This fixture is module-scoped for efficiency - the processor
...
def pytest_collection_modifyitems(
    ...
    This allows flexible test execution like:
        pytest --test-function test_submit_rfq_request
        pytest --test-markers "integration,unit"
        MCP_RFQ_TEST_FUNCTION=test_submit_rfq_request pytest
    """
